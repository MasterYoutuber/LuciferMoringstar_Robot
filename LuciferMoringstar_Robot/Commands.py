...
from Config import START_MSG, CHANNELS, ADMINS, AUTH_CHANNEL, CUSTOM_FILE_CAPTION, TUTORIAL, BROADCAST_CHANNEL, DB_URL, SESSION, ADMIN_ID, START_IMG, PICS
    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        ...
        try:
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('🖥️ OTT UPDATES 🖥️', url=f'https://t.me/dvdnewupdates')
                    ],
                    [
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton
                            (
                                "🥇OUR GROUP🥇", url="https://t.me/efcinema"
                            )
                    ],
                    [
                        InlineKeyboardButton
